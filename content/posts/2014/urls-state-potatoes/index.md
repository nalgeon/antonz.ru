...
<figure><img alt="Строка или число" src="state-scalar.png"></figure>
</div>
<div class="col-xs-12 col-sm-4">
<figure><img alt="Логическое значение" src="state-bool.png"></figure>
</div>
<div class="col-xs-12 col-sm-4">
<figure><img alt="Дата и время" src="state-date.png"></figure>
</div>
</div>

<div class="row">
<div class="col-xs-12 col-sm-4">
<figure><img alt="Пустое значение" src="state-empty.png"></figure>
</div>
<div class="col-xs-12 col-sm-4">
<figure><img alt="Список (массив)" src="state-list.png"></figure>
</div>
<div class="col-xs-12 col-sm-4">
<figure><img alt="Словарь (карта)" src="state-dict.png"></figure>
</div>
</div>
